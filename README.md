...
| 🛡 **Защищает сервер** | Вход по ключу, фаервол, fail2ban, автоматические обновления безопасности |
| 🧩 **Ставит модули** | Docker и Caddy уже готовы; VPN, хранилище, фото и другое — на подходе |
...
Один и тот же экран модулей — стиль выбирается при первом запуске и переносится на сервер.

<table>
<tr>
<td width="33%"><img src="docs/screenshots/modules-graphite.png" alt="Экран модулей в стиле Графит"></td>
<td width="33%"><img src="docs/screenshots/modules-glass.png" alt="Экран модулей в стиле Стекло"></td>
<td width="33%"><img src="docs/screenshots/modules-terminal.png" alt="Экран модулей в стиле Терминал"></td>
</tr>
<tr>
...
- [x] Модули «Защита сервера» и «Docker и Caddy»
- [x] Дашборд сервера и обновления агента с проверкой подписи
- [ ] Магазин модулей
- [ ] VPN на AmneziaWG: устройства, маршруты и маскировка
...
и ждёт подтверждения. Модуль «Docker и Caddy» откажется работать, если порты 80 и 443 занял чужой веб-сервер,
